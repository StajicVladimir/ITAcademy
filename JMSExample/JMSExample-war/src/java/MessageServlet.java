 ...
 * @author Vladimir
 */
@WebServlet(urlPatterns = {"/MessageServlet"}, description="Message Servlet",
        name = "MessageSevlet")
...
// 
//        //con = (Connection) con_factory.createConnection();
//session = con_factory.createConnection().createSession(false, Session.AUTO_ACKNOWLEDGE);
//
