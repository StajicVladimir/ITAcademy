...
<db:setDataSource driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost/movies_g4" user="root" password="" />
    ...
    <div id="body">
      <div class="inner">
        ...
        <c:forEach items="${filmovi.rows}" var="film">
            ...
            <ct:film title="${film.title}" price="${film.price}" slika="${film.slika}" lprice="${lprice}" lbuy="${lbuy}"></ct:film>
